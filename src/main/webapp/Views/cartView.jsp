		...
		<form action="${pageContext.request.contextPath }/order" method="post"
			...
			<table border="1">
				...
				<tr>
					...
					<td><input type="radio" name="paymentMode" value="cash" checked="checked"
						onclick="document.getElementById('uploadDiv').style.display='none';" />
						Thanh toán tiền mặt khi nhận hàng <br>
						
						<input type="radio"
						name="paymentMode" value="transfer" onclick="document.getElementById('uploadDiv').style.display='block';" />
						...
						<input type="radio" name="paymentMode" value="vnpayment"
						onclick="document.getElementById('uploadDiv').style.display='none';" />
						Thanh toán vnPay <br>
